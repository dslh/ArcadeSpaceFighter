...
static func emit_from_collisions(state: Physics2DDirectBodyState, sparks: PackedScene, container: Node):
...
static func emit_from_collision(state: Physics2DDirectBodyState, index: int, sparks: PackedScene, container: Node):
